...
//____________________________________________________________________________________________________________________________________________  
  SESSION_ID: process.env.SESSION_ID || 'Phoenix~LuckyOmen',
  STICKER_DATA: process.env.STICKER_DATA || '⋆⏤͟͟͞͞✮⃝🕊️ρ⃮⃗ꪖ᥇ꪶ⃮⃗ꪮ  ɀꫀ𝘳⃮⃗⋆⏤͟͟͞✮⃝🍒
  ...
  AUDIO_DATA: process.env.AUDIO_DATA || '𝚸𝚫𝚩𝐋𝚯 𝐒𝚵𝚪;𝚸𝚫𝚩𝐋𝚯 𝐒𝚵𝚪;https://files.catbox.moe/x3j5wj.png',
  BOT_INFO: process.env.BOT_INFO || '', 
  PREFIX: process.env.PREFIX || '👻',
  MODE: process.env.MODE || 'public',
  SUDO: process.env.SUDO || '9074700613',
